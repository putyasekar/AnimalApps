...
public class AnimalData {
    public static String[][] data = new String[][]{
            {"Komodo",
                    ...
                    "Varanus komodoensis",
                    "Habitat komodo adalah padang rumput terbuka (sabana) dan hutan belukar, terkadang juga di pesisir pantai. Komodo beraktivitas pada siang hingga sore hari, tetapi tetap berteduh ketika suhu udara sangat panas",
                    "Kingdom\t\t\t: Animalia\n" +
                            "Filum\t\t\t\t\t: Chordata\n" +
                            "Kelas\t\t\t\t\t: Reptilia\n" +
                            "Ordo\t\t\t\t\t: Squamata\n" +
            ...
            {"Kerbau Anoa",
                    ...
                    "Habitat anoa berada di hutan tropika dataran, sabana (savanna), terkadang juga dijumpai di rawa-rawa. Mereka merupakan penghuni hutan yang hidupnya berpindah-pindah tempat",
                    "Kingdom\t\t\t: Animalia\n" +
                            "Filum\t\t\t\t\t: Chordata\n" +
                            "Kelas\t\t\t\t\t: Mamalia\n" +
                            "Ordo\t\t\t\t\t: Artiodactyla\n" +
            ...
            {"Orangutan Sumatera",
                    ...
                    "Pongo abelli",
                    "Orangutan Sumatra endemik dari pulau Sumatra dan hidupnya terbatas di bagian utara pulau itu. Di alam, orangutan Sumatra bertahan di provinsi Aceh (NAD), ujung paling utara Sumatra. Primata ini dulu tersebar lebih luas, saat mereka ditemukan lebih ke Selatan tahun 1800-an seperti di Jambi dan Padang. Ada populasi kecil di provinsi Sumatra Utara sepanjang perbatasan dengan NAD, terutama di hutan-hutan danau Toba. Survei di danau Toba hanya menemukan dua areal habitat, Bukit Lawang (didefinisikan sebagai suaka margasatwa) dan Taman Nasional Gunung Leuser.",
                    "Kingdom\t\t\t: Animalia\n" +
                            "Filum\t\t\t\t\t: Chordata\n" +
                            "Kelas\t\t\t\t\t: Mamalia\n" +
                            "Ordo\t\t\t\t\t: Primata\n" +
            ...
            {"Monyet Hitam",
                    ...
                    "Macaca nigra",
                    "Yaki dapat dijumpai di hutan primer dan sekunder, daerah pesisir maupun di dataran tinggi hingga ketinggian 2000 di atas permukaan laut (dpl). Dari beberapa habitat hidupnya, yaki lebih menyukai tinggal di hutan primer, karena cocok untuk tempat tidur dan mencari makan. Mereka juga sering turun ke perkebunan untuk mencari makan dan merusak panen, sehingga yaki sering dianggap sebagai hama tanaman.",
                    "Kingdom\t\t\t: Animalia\n" +
                            "Filum\t\t\t\t\t: Chordata\n" +
                            "Kelas\t\t\t\t\t: Mammalia\n" +
                            "Ordo\t\t\t\t\t: Primata\n" +
    ...
    public static ArrayList<Animal>getListAnimal() {
        ...
        for (String[] aData : data) {
            ...
            animal.setLatin(aData[3]);
            animal.setHabitat(aData[4]);
            animal.setClassification(aData[5]);
            animals.add(animal);
        }
        return animals;
    }
